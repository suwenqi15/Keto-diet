(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["Record-record-module"], {
    ...
    function srcAppRecordRecordRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
      ...
      RecordRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
    ...
    function srcAppRecordRecordModuleTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _record_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./record.page */
      "./src/app/Record/record.page.ts");
      /* harmony import */
      ...
      var _record_routing_module__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      ...
      RecordModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        imports: [_ionic_angular__WEBPACK_IMPORTED_MODULE_1__["IonicModule"], _angular_common__WEBPACK_IMPORTED_MODULE_3__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormsModule"], _explore_container_explore_container_module__WEBPACK_IMPORTED_MODULE_6__["ExploreContainerComponentModule"], _record_routing_module__WEBPACK_IMPORTED_MODULE_7__["RecordRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["ReactiveFormsModule"]],
        declarations: [_record_page__WEBPACK_IMPORTED_MODULE_5__["RecordPage"], _foodcard_foodcard_component__WEBPACK_IMPORTED_MODULE_8__["FoodCardComponent"], _card_card_component__WEBPACK_IMPORTED_MODULE_9__["CardComponent"]]
      })], RecordModule);
      /***/
    },
    ...
    function srcAppRecordRecordPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _services_record_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ../services/record.service */
      "./src/app/services/record.service.ts");

      var RecordPage = /*#__PURE__*/function () {
        function RecordPage(dailyrecorddb, http) {
          ...
          this.Data = [];
          this.sortKey = null;
          this.sortDirection = 0; // Chart Data
          ...
          this.chartType = 'line';
          this.showLegend = false; // For search

          this.stock = 'AAPL'; //default segment
        ...
        _createClass(RecordPage, [{
            ...
            this.http.get("https://financialmodelingprep.com/api/v3/historical-price-full/".concat(this.stock, "?from=2018-03-12&to=2019-03-12")).subscribe(function (res) {
              ...
              try {
                for (_iterator.s(); !(_step = _iterator.n()).done;) {
                  ...
                  _this.chartLabels.push(entry.date);

                  _this.chartData[0].data.push(entry['close']);
                }
              } catch (err) {
                _iterator.e(err);
              } finally {
          ...
          value: function loadtableData() {
            ...
            this.http.get("https://randomuser.me/api/?page=".concat(this.page, "&results=").concat(this.resultsCount)).subscribe(function (res) {
              _this2.data = res['results'];
            });
          }
        }, {
          key: "nextPage",
