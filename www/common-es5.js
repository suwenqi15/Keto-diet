(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
    ...
    /***/
    function srcAppFoodcardFoodcardComponentTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var FoodCardComponent = /*#__PURE__*/function () {
      ...
      FoodCardComponent.ctorParameters = function () {
        return [];
      };

      FoodCardComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        //selector: 'ion-item',
        selector: 'kyt',
        template: '<h2> kaiyan template </h2>' //   templateUrl: 'tab1.page.html',
    ...
    /***/
    function srcAppServicesRecordServiceTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var RecordService = /*#__PURE__*/function () {
        function RecordService(dbservice, httpClient, sqlPorter) {
        ...
        _createClass(RecordService, [{
          ...
          value: function getData() {
            ...
            this.httpClient.get('assets/data.sql', {
              ...
              _this.sqlPorter.importSqlToDb(_this.dbservice.getdb(), data).then(function (_) {
                _this.getRecords();

                _this.dbservice.getDbReady().next(true);
          ...
          value: function getRecords() {
            ...
            return this.dbservice.getdb().executeSql('SELECT * FROM dailyrecordtable', []).then(function (res) {
              var items = [];
              ...
              _this2.recordsList.next(items);
            });
          }
        }, {
          key: "addRecord",
          value: function addRecord(timeframe, dailycho, dailyfat) {
            var _this3 = this;

            var data = [timeframe, dailycho, dailyfat];
            return this.dbservice.getdb().executeSql('INSERT INTO dailyrecordtable (timeframe, dailycho, dailyfat ) VALUES (?, ?, ?)', data).then(function (res) {
              _this3.getRecords();
            });
          }
        }]);
